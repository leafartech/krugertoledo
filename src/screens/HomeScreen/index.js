            ...
            <Main>
                ...
                <Section top={true}>
                    ...
                    <div className={ 'flex' } style={{ marginTop: '24px'}}>
                        <Card href="/equipe/bossuet" name="Nome da pessoa" path="1" position="Advogado master e sócio fundador" text="Texto curto que apresente de forma direta, rápida e concisa a pessoa correspondente"></Card>
                        <Card href="/equipe/zola" name="Nome da pessoa" path="2" position="Advogado master e sócio fundador" text="Texto curto que apresente de forma direta, rápida e concisa a pessoa correspondente"></Card>
                    </div>
                </Section>
                <Section top={true}>
