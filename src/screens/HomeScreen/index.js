...
export default function HomeScreen() {
    return (
        <div className={ styles['home-screen']}>
            ...
            <Main>
                <Section>
                    <Title tag="h2" top="Seriedade e Excelência">Atendimento personalizado feito por especialistas</Title>
                ...
                <Section top={true}>
                    ...
                    <div className={ styles.flex } style={{ marginTop: '24px'}}>
                        <Card href="/" name="Nome da pessoa" path="1" position="Advogado master e sócio fundador" text="Texto curto que apresente de forma direta, rápida e concisa a pessoa correspondente"></Card>
                        <Card href="/" name="Nome da pessoa" path="2" position="Advogado master e sócio fundador" text="Texto curto que apresente de forma direta, rápida e concisa a pessoa correspondente"></Card>
                    </div>
                </Section>
                <Section top={true}>
